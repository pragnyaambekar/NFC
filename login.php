                ...
                <div class="panel-group">
                    <div class="panel panel-primary">
                        ...
                        <center><button type="submit" class="btn" name="submit">Login</button>
                            <h5>Dont have an account? <a href="signup/signup.php">Signup here</a> </h5>
                        </center>
                    </div>
                </div>
            </form>
...
if(isset($_POST['submit'])){
    ...
    if(mysqli_num_rows($email_password_result)){
        ...
        echo"<center><h3>Incorrect email or password. New user? <button class='btn signup'><a href='../signup/signup.php' >Signup here</a></button><h3><center>";
    }
